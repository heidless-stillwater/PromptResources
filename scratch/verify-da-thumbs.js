...
async function debug() {
    const snap = await db.collection('resources').where('attributedUserIds', 'array-contains', 'stub_digital-assets').get();
    snap.docs.forEach(d => console.log(d.id, d.data().thumbnailUrl));
}
