...
async function debug() {
    const tokens = ['digital', 'assets'];
    const snap = await db.collection('resources').where('searchKeywords', 'array-contains-any', tokens).get();
    console.log(`Resources with keywords "digital" or "assets": ${snap.size}`);
